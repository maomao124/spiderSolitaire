...
public class Spider extends JFrame
{
    ...
    //生成纸牌数组
    private final PKCard[] cards = new PKCard[104];
    private final JLabel clickLabel;
    private int c = 0;
    private int n = 0;
    private int a = 0;
    ...
    public Spider()
    {
        ...
        //移动此组件并调整其大小。左上角的新位置由x和y指定，新大小由width和height指定。
    ...
    public void deal()
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            ...
            if (cards[c + i].getCardValue() == 1)
            {
                ...
                point.y -= 240;
                PKCard card = this.table.get(point);
